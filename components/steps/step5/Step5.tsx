...
const Step5: React.FC = () => {
  ...
  return (
    <>
      <div className="mx-auto p-6 pt-2 mt-4 bg-white rounded-lg shadow">
        <h2 className="text-2xl font-bold text-[#005646] mb-5">
          Last step to validate your appointment
        </h2>
        ...
        <div className="bg-[#015546] text-white rounded-xl p-7 shadow-lg w-full max-w-2xl ">
          ...
          <p className="text-md font-semibold text-white mb-2">
            Your credit card allows you to confirm the reservation,
            <span className=" text-[#CBF595]">
              {" "}
              no amount will be debited before the end of the appointment
            </span>
          </p>
          ...
          <p className="text-md font-semibold text-white">
            <span className=" text-[#CBF595]">Free cancellation</span> up to 24
        ...
        <div className="flex items-center space-x-2 mt-2">
          <div
            className={`flex items-center border rounded-full px-4 py-2 transition-all duration-200 cursor-pointer ${
              isActive
          ...
          >
            ...
            {!isActive ? (
              <span className="ml-2 text-[#056f66] text-sm font-semibold">
                Apply a promo code or sponsorship
              </span>
            ) : (
              <input
                type="text"
        ...
        <div className=" p-1 border-b-2">
          <h2 className="text-2xl font-bold text-[#005646] mb-2 mt-3">
            To be paid on the day of the appointment
          </h2>
          <p className="text-md font-medium text-[#005646] mb-5">
            On the big day, your signature will trigger the debit on the credit
        ...
        <div className="bg-[#E7F9FE] p-4  items-center justify-between rounded-lg shadow">
          <div className="flex items-center w-full">
            ...
            <span className="text-blue-900 font-bold text-lg">
              ...
              if your device is repaired
            </span>
          </div>
          <a
            href="#repair-bonus"
            className="flex items-center text-[#1A8E96] hover:text-[#38b9c2] mt-6 cursor-pointer"
          >
            <svg
