  ...
  return (
    <div className="mx-auto p-6 mt-4 bg-white rounded-lg shadow">
      ...
      <div className="bg-[#E7F9FE] p-4  items-center justify-between rounded-lg shadow">
        ...
        >
          <InformationCircleIcon className="w-6 h-6 mr-2 bg-inherit text-inherit " />{" "}
          {/* Heroicon for info */}
      ...
      <div className="flex items-center text-[#005646] mt-10  p-3 rounded-lg ">
        ...
        <span className="flex-grow">
          ...
          <span className="font-bold text-[#005646]">
            {" "}
            €110 initial repair package
          </span>
          will be transformed into a voucher valid for our reconditioned
          devices.
        </span>
      </div>
    </div>
