        ...
        <div className="w-full">
            <Combobox value={selected} onChange={setSelected}>
                <div className="relative float-label-input m-0">
                    <div
                        className={`relative w-full cursor-default overflow-hidden text-left border border-gray-300 focus-within:border-gray-300 focus-within:ring-1 focus-within:ring-gray-300 ${props.borderRadius === "50%" ? "rounded-full" : "rounded-lg"
                            }`}
                    >
                        <Combobox.Input
                        ...
                        <label
                            ...
                            className={`absolute left-3 transition-all duration-100 ease-in text-sm pointer-events-none ${isFocused || query
